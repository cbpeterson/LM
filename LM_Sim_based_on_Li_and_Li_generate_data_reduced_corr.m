...
for model = 1:nmodel
   ...
   % Variance tau^2
    ...
    for iter = 1:niter
        ...
        csvwrite(strcat(input_folder, 'X_', num2str(iter), '_model', num2str(model), 'corr5.csv'), X);
        csvwrite(strcat(input_folder, 'X_test_', num2str(iter), '_model', num2str(model), 'corr5.csv'), X_test);
        csvwrite(strcat(input_folder, 'Y_', num2str(iter), '_model', num2str(model), 'corr5.csv'), Y);
        csvwrite(strcat(input_folder, 'Y_test_', num2str(iter), '_model', num2str(model), 'corr5.csv'), Y_test);
    end
end