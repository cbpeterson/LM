...
for model = 1:nmodel
    ...
    parfor cur_iter = 1:niter
        ...
        X = csvread(strcat(input_folder, 'X_', num2str(cur_iter), '_model', num2str(model), 'corr5.csv'));
        X_test = csvread(strcat(input_folder, 'X_test_', num2str(cur_iter), '_model', num2str(model), 'corr5.csv'));
        Y = csvread(strcat(input_folder, 'Y_', num2str(cur_iter), '_model', num2str(model), 'corr5.csv'));
        Y_test = csvread(strcat(input_folder, 'Y_test_', num2str(cur_iter), '_model', num2str(model), 'corr5.csv'));
